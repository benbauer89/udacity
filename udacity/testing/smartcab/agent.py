...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=True, epsilon=1.0, alpha=0.5):
        ...
        ## self.learning = learning # Whether the agent is expected to learn for part 6 and ongoing
    ...
    def createQ(self, state):
        ...
        if self.learning == True:
            if not self.Q or state not in self.Q:
                self.Q[state] = {None: 0.00,   'left':0.0, 'right':0.0,    'forward':0.0}
    ...
    def choose_action(self, state):
        ...
        if self.learning == False:
            ...
            if coin <= self.epsilon:
                ...
                maxQ_actions = [key for key in self.Q[state].keys() if self.Q[state][key] == highest]
